                                                ...
                                                <div class="card">
                                                  ...
                                                  <div class="row form-group">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                          <input   required  type="text" class="form-control" name="name"  id="name"    value="<?php echo $record[0]->name;?>"   >
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                          <input   required type="text" class="form-control" name="mobile"  id="mobile"   value="<?php echo $record[0]->mobile;?>">
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                          <input  required   type="text" class="form-control" name="email"  id="email"   value="<?php echo $record[0]->email;?>">
                                                        </div>
                                                      </div>
                                                      <div class="row form-group">
                                                        <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                          <input   required  type="text" class="form-control" name="address"  id="address"   value="<?php echo $record[0]->address;?>">
                                                        </div>
                                                      </div>
